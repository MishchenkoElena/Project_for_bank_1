...
***10. Функция data_reader_csv_excel***

Функция для считывания финансовых операций принимает путь к файлу CSV или Excel в качестве аргумента. Возвращает 
...
Проверка корректного считывания файла, а также выброса ошибки в случае отсутствия файла, или указания некорректного 
формата данных
